...
const trophies = [
  { id: 1, title: 'MORPHD 1 Meme', unlocked: true, icon: '/trophies/trophy1.png' },
      ...
      <main className="flex flex-col items-center">
        <div className="bg-custom-gray rounded-xl p-6 w-full max-w-5xl">
          <h2 className="text-3xl sm:text-4xl font-black text-center">
            <span className="text-green-600">MORPH&apos;D</span> <span className="text-white">TROPHIES</span>
          </h2>
            ...
            {trophies.map((trophy) => (
              ...
              >
                {trophy.unlocked ? (
                  ...
                  <div className="text-center font-bold text-sm">{trophy.title}</div>
                )}
              </div>
            ))}
          </div>
